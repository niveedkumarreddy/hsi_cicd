...
#                                                                                                                                                               #
# Usage:                                                                                                                                                        #
#   ./importSchedulers.sh <LOCAL_DEV_URL> <X_INSTANCE_API_KEY> <repoName> <HOME_DIR> <SINGLE_SCHEDULER>                                                # Gen-2 #
#                                                                                                                                                               #
# Example:                                                                                                                                                      #
#   ./importSchedulers.sh \                                                                                                                                     #
#     "http://localhost:5555" \                                                                                                                                 #
...
function projectImportschedulers() {
  ...
  if [ "$SINGLE_SCHEDULER" == "true" ]; then
    importSingleScheduler "$LOCAL_DEV_URL" "$X_INSTANCE_API_KEY" "$repoName" "$HOME_DIR" # Gen-2: Updated function call
  else
    importScheduler "$LOCAL_DEV_URL" "$X_INSTANCE_API_KEY" "$repoName" "$HOME_DIR" "$SINGLE_SCHEDULER" # Gen-2: Updated function call
  fi
}
